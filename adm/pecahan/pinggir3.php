    ...
    <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details cyan darken-2">
                <div class="row">
                    ...
                    <div class="col col s8 m8 l8">
                        ...
                        <p class="user-roal black-text">Loket Obat</p>
                        </b>
                    </div>
                </div>
            </li>
            <!-- <li class="bold"><a href="obat-dashboard" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a> -->
            </li>
            <li class="bold"><a href="obat" class="waves-effect waves-cyan"><i class="mdi-maps-local-pharmacy"></i> Master Obat</a></li>                   
            <li class="bold"><a href="obat-masuk" class="waves-effect waves-cyan"><i class="mdi-navigation-arrow-forward "></i> Obat Masuk</a></li>                   
            <li class="bold"><a href="obat-keluar" class="waves-effect waves-cyan"><i class="mdi-navigation-arrow-back"></i> Obat Keluar
            <?php 
              $qjum1 = mysqli_query($koneksi,"select count(stts) as semua from periksa where stts='2'");
            ...
            <li class="bold"><a href="record-obat-masuk" class="waves-effect waves-cyan"><i class="mdi-action-assignment"></i> Record Obat Masuk</a></li>                   
            <li class="bold"><a href="record-obat-keluar" class="waves-effect waves-cyan"><i class="mdi-action-assignment"></i> Record Obat Keluar</a></li>                   
      ...
      <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                <button class="waves-effect waves-red btn-flat" name="pinggir3">Perbarui </button>
    ...
    if (isset($_POST['pinggir3'])) {
      ...
      if (($pass_default=="d41d8cd98f00b204e9800998ecf8427e") && ($foto_default=="d41d8cd98f00b204e9800998ecf8427e")) {
        ...
        if ($update1 == TRUE) {
          ...
          echo "<script>window.location='obat-dashboard'</script>";
        }else{
      ...
      elseif (($pass_default!=="d41d8cd98f00b204e9800998ecf8427e") && ($foto_default=="d41d8cd98f00b204e9800998ecf8427e")) {
        ...
        if ($update1 == TRUE) {
          echo "<script>Lobibox.notify('default', {
                        ...
                        hideClass: 'fadeUpDown',
                        msg: 'Pembaruan Berhasil'
                    });</script>"."<script>window.location='obat-dashboard'</script>";
        }else{
          echo "<script>alert('gagal')</script>";
        }
      }
                ...
                if (file_exists($nmfile)) {
                  ...
                  if ($upload == TRUE) {
                    $input = mysqli_query($koneksi,"update pengguna set 
                                                    ...
                                                    alamat        = '$alamat',
                                                    foto          = '$nmfile1' where id_pengguna='$sesid'") or die (mysqli_error());
                    // header("location:obat-dashboard");
                    if ($input == TRUE) {
                      echo "<script>Lobibox.notify('default', {
                                    iconClass: false,
                                    size: 'mini',
