    ...
    <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <div class="row">
                    ...
                    <div class="col col s8 m8 l8">
                        <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <li><a href="html2pdf/examples/cetak.php?id=<?php echo $sesid; ?>"><i class="mdi-action-print"></i> Kartu</a>
                            </li>
                            <li class="divider"></li>
                        ...
                        <p class="user-roal black-text">Pasien</p>
                        </b>
                    </div>
                </div>
            </li>
            <!-- <li class="bold"><a href="pasien-dashboard" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a> -->
            </li>
            <li class="bold"><a href="periksa" class="waves-effect waves-cyan"><i class="mdi-av-my-library-books"></i> Daftar Periksa</a></li>                   
            <li class="bold"><a href="rm" class="waves-effect waves-cyan"><i class="mdi-av-my-library-books"></i> Rekam Medik</a></li>                   
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-av-queue"></i> Artikel</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="postingan">Postingan</a>
                                </li>                                        
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-communication-chat"></i> Konsultasi
                    <?php 
                      $qjum1 = mysqli_query($koneksi,"select count(status) as semua from konsultasi where status='1' && pengirim='$sesuname'");
                    ...
                    ?>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="record-konsultasi">Record Konsultasi<?php if ($rjum1['semua']>0) {
                                    echo "<span class='new badge'>".$rjum1['semua']."</span>";
                                  }else{

                                  } ?></a>
                                </li>                                        
                                <li><a href="konsultasi">Input Konsultasi</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                <button class="waves-effect waves-red btn-flat" name="pinggir4">Perbarui </button>
    ...
    if (isset($_POST['pinggir4'])) {
      ...
      if (($pass_default=="d41d8cd98f00b204e9800998ecf8427e") && ($foto_default=="d41d8cd98f00b204e9800998ecf8427e")) {
        ...
        if ($update1 == TRUE) {
          ...
          echo "<script>window.location='pasien-dashboard'</script>";
        }else{
      ...
      elseif (($pass_default!=="d41d8cd98f00b204e9800998ecf8427e") && ($foto_default=="d41d8cd98f00b204e9800998ecf8427e")) {
        ...
        if ($update1 == TRUE) {
          echo "<script>Lobibox.notify('default', {
                        ...
                        hideClass: 'fadeUpDown',
                        msg: 'Pembaruan Berhasil'
                    });</script>"."<script>window.location='pasien-dashboard'</script>";
        }else{
          echo "<script>alert('gagal')</script>";
        }
      }
