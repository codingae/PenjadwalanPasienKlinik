            ...
            <div class="row">
              ...
              ?>
                <form action="" method="POST">
                  ...
                  <div class="col s12">
                    <textarea id="ckeditor1" name="ckeditor"><?php echo $rw['isi']; ?></textarea>
                  </div>
                  <div class="input-field col s12">
...
<?php 
  if (isset($_POST['artikel'])) {
    ...
    $isi   = $_POST['ckeditor'];
    $date  = date("Y-m-d");
    $query = mysqli_query($koneksi,"INSERT INTO artikel VALUES ('','$judul','$isi','','$sesuname','$date','1')");
    if ($query==TRUE) {
      echo "<script>Lobibox.notify('default', {
                    ...
                    msg: 'Selamat Artikel Anda Sudah Diterbitkan'
