      ...
      <div class="row">
        ...
        <div class="col s4 m4 l4">
          ...
          <b><?php while ($mrwww = mysqli_fetch_array($mqrrr)) {
            echo $mrwww['nama_obat']. " (".$mrwww['jml_ok'].")<br>";
          } ?></b>
        </div>
        <div class="col s6 m6 l6 right">
          ...
          <table class="responsive-table">
            ...
            ?>
            <tr>
              <td><?php echo $mrw['id_masterlayanan3']; ?></td>
            </tr>
            <?php
    ...
    <div class="invoice-footer">
      <div class="row">
        ...
        <div class="col s12 m6 l6 center-align">
          ...
          <p class="header"><?php echo ucfirst($sesuname); ?></p>
          <p><?php if ($_SESSION['level']=="c81e728d9d4c2f636f067f89cc14862c") {
